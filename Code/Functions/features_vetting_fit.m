...
% This function does features vetting according to description: 
% - feature-feature correlation < 0.8. Use Spearman correlation. 
% - feature-target correlation. Use Relieff algorithm.
% Sinces some features are found in negative percentage in feature-target
% correlation, the function chooses the highest scores of the bunch that
% are under 0.8 with the best correlation to get 20 features.
